...
ADD_RELATIONSHIP_SCHEMA = {
    "description": "添加两个 idea 之间的关系（builds_on/alternative_to/complementary/combines_with）",
    "parameters": {
        "type": "object",
        "properties": {
            "idea_a": {"type": "string", "description": "第一个 idea ID (如 T001-I001)"},
            "idea_b": {"type": "string", "description": "第二个 idea ID (如 T001-I002)"},
            "rel_type": {"type": "string", "description": "关系类型", "enum": list(VALID_REL_TYPES)},
            "topic_dir": {"type": "string", "description": "topic 目录路径", "default": "."},
        },
        "required": ["idea_a", "idea_b", "rel_type"],
    },
}

GET_GRAPH_SCHEMA = {
    "description": "获取完整的 idea 关系图（markdown 格式）",
    "parameters": {
        "type": "object",
        "properties": {
            "topic_dir": {"type": "string", "description": "topic 目录路径", "default": "."},
...
SUGGEST_COMBINATIONS_SCHEMA = {
    "description": "建议可组合的 idea 对",
    "parameters": {
        "type": "object",
        "properties": {
            "topic_dir": {"type": "string", "description": "topic 目录路径", "default": "."},
