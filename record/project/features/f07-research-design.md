...
- `agents/refinement_agent.py:111-144` — `build_prompt()`，理论深化 + 模块设计
...
- `agents/theory_check_agent.py:69-91` — `build_prompt()`，理论交叉验证
...
**TheoryCheckAgent**：提取关键声明 → 文献交叉验证 → 写 `theory_review.md`（≥1500 字符）
